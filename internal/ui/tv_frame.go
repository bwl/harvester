...
func (t *tvFrame) GetPosition() rendering.Position { return rendering.Position{Horizontal: rendering.Left, Vertical: rendering.Top} }
...
func (t *tvFrame) GetGlyphs() [][]rendering.Glyph {
	...
	for y:=0; y<t.h; y++{ g[y] = make([]rendering.Glyph, t.w) }
